...
export default function CookieConsent({ lang = 'el' }: { lang?: 'el' | 'en' }) {
  ...
  const t = {
      el: {
          ...
          desc: "Χρησιμοποιούμε cookies για να βελτιώσουμε την εμπειρία σας, να αναλύσουμε την επισκεψιμότητα και να βελτιστοποιήσουμε τις καμπάνιες μας (Google/Meta Ads). Ευχαριστούμε για την εμπιστοσύνη σας.",
          accept: "Αποδοχή",
          decline: "Απόρριψη",
